# settings_ui.py é um arquivo que contém a interface gráfica da janela de configurações.
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.btn_import.setGeometry(QtCore.QRect(150, 530, 93, 28))
        self.btn_import.setStyleSheet("font: 63 10pt \"Segoe UI\";")
        self.btn_import.setObjectName("btn_import")
        
        # Botão Export
        self.btn_export = QtWidgets.QPushButton(Form)
        self.btn_export.setGeometry(QtCore.QRect(260, 530, 93, 28))
        self.btn_export.setStyleSheet("font: 63 10pt \"Segoe UI\";")
        self.btn_export.setObjectName("btn_export")
        
        # Botão Restore (apenas para esta janela)
        self.btn_restore_defaults = QtWidgets.QPushButton(Form)
        self.btn_restore_defaults.setGeometry(QtCore.QRect(370, 530, 93, 28))
        self.btn_restore_defaults.setStyleSheet("font: 63 10pt \"Segoe UI\";")
        self.btn_restore_defaults.setObjectName("btn_restore_defaults")
        
        # Botão Save
        self.btn_apply = QtWidgets.QPushButton(Form)
        self.btn_apply.setGeometry(QtCore.QRect(480, 530, 93, 28))
        self.btn_apply.setStyleSheet("font: 63 10pt \"Segoe UI\";")
        self.btn_apply.setObjectName("btn_apply")
        
        # Botão Cancel
        self.btn_cancel = QtWidgets.QPushButton(Form)
        self.btn_cancel.setGeometry(QtCore.QRect(590, 530, 93, 28))
        self.btn_cancel.setStyleSheet("font: 63 10pt \"Segoe UI\";")
        self.btn_cancel.setObjectName("btn_cancel")
        
        # Label informativa acima dos botões
        self.label_info = QtWidgets.QLabel(Form)
        self.label_info.setGeometry(QtCore.QRect(150, 500, 533, 20))
        self.label_info.setStyleSheet("font: 63 10pt \"Segoe UI\"; color: #000000;")
    ...
    def retranslateUi(self, Form):
        ...
        self.btn_restore_defaults.setText(_translate("Form", "Restore"))
        self.label_info.setText(_translate("Form", "* HSV values will be exported/ imported too."))
